...
#routing to the Car Sales Analysis
@app.route('/z',methods=['GET'])
#portion for data visualization and analysis for Car Sales Analysis
def visualize1():
     #reading the dataset
...
def predict():
    ...
    if request.method == 'POST':
        ...
        if output<0:
            ...
            return render_template('i.html',prediction_text="You Can Sell The Car at {}".format(output))
    else:
        return render_template('i.html')
